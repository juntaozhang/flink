 ...
 */
public class TwoStreamWatermarkExample {
    public static void main(String[] args) throws Exception {
        ...
        env
                ...
                .setCheckpointStorage(
                        "file:///Users/juntzhang/src/juntzhang/flink/flink-examples/flink-examples-streaming/checkpoints/TwoStreamWatermarkExample");
        env
                .getCheckpointConfig()
        ...
        final SingleOutputStreamOperator<User> a1 = getSrc(env, 19998);
        final SingleOutputStreamOperator<User> a2 = getSrc(env, 19999);
        final DataStream<User> a = a1.union(a2);
        ...
        b.print("[normal]").setParallelism(1);
...
//                                .withIdleness(Duration.ofSeconds(10))
    ...
    static class User {
        ...
        public String toString() {
            return id + "{eventTime=" + getEventTimeStr() + ", tracking=" + StringUtils.join(
                    tracking,
                    "|") + "}";
        }
    }
