...
//    }
    ...
    void testCoGroup() throws Exception {
        ...
        DataStream<Tuple2<String, Integer>> coGroupedStream = stream1
                .coGroup(stream2)
                ...
                .apply(new CoGroupFunction<Tuple2<String, Integer>, Tuple2<String, Integer>, Tuple2<String, Integer>>() {
                    @Override
                    public void coGroup(Iterable<Tuple2<String, Integer>> first, Iterable<Tuple2<String, Integer>> second, Collector<Tuple2<String, Integer>> out) {
                        for (Tuple2<String, Integer> left : first) {
                            for (Tuple2<String, Integer> right : second) {
                                out.collect(new Tuple2<>(left.f0, left.f1 + right.f1));
                            }
                        }
                    }
                });
