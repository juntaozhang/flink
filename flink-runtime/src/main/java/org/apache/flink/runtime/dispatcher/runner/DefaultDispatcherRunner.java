 ...
 * the leader election. 负责启动和管理Dispatcher组件，并支持对Dispatcher组件的Leader选举。
 * 当Dispatcher集群组件出现异常并停止时，会通过DispatcherRunner重新选择和启动新的Dispatcher服务，从而保证Dispatcher组件的高可用。
 */
